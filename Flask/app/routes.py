...
questions_7 = [ #question_<seu módulo>
    {
        'id': 1, #id segue padrão para todas
        'question': 'Qual é o principal objetivo do Planning Poker no SCRUM?', #coloque sua pergunta aqui
        'options': ['Determinar quem são os membros mais rápidos da equipe', 'Estabelecer um consenso sobre o esforço necessário para as tarefas.', 'Aumentar a competição entre os membros da equipe', 'Acelerar o processo de desenvolvimento de software.', 'Identificar os membros da equipe que precisam de treinamento adicional.'], #opções de resposta
        'answer': 'Estabelecer um consenso sobre o esforço necessário para as tarefas.' #insira a resposta certa 
    },
    {
        'id': 2,
        'question': 'O que a auto-organização promove nas equipes ágeis?',
...
@app.route('/mod_7') #seu módulo normal
def modulo_7():
    return render_template('mod_7.html')
